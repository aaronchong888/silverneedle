  ...
  $.getJSON("handleLoadAllNotes.php", function(jsonData){
    ...
    $.each(jsonData.notes, function(i, note){
      ...
      //          append this <li> element to the end of the "#ulNotes" element.
		...
		$("#ulNotes").append("<li><h3 class=\"clickableTitle\" noteId="+note["id"]+">"+note["title"]+"</h3><h4>"+note["content"]+"</h4></li>"); 
...
function saveNewNote(){
  ...
  $.get( "handleNewNote.php?title="+newTitle+"&content="+newContent, function(data, status){
	...
	txt = "<li><h3 class=\"clickableTitle\" noteId="+data+">"+newTitle+"</h3><h4>"+newContent+"</h4></li>";
...
function showUpdate(){
  ...
  $("#noteContent").val($(this).next().html());
...
function updateNote(){
  ...
  $.get( "handleUpdate.php?title="+newTitle+"&content="+newContent+"&id="+id, function(data, status){
    if(data=="updateSuccess"){
	  ...
	  txt = "<li><h3 class=\"clickableTitle\" noteId="+id+">"+newTitle+"</h3><h4>"+newContent+"</h4></li>";
